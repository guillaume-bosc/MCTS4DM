...
fileData = folder.'/qualities.data'
fileResult = folder.'/qualities_'.XP.'_'.dataset.'.pdf'
...
set ylabel "Quality"  offset 7,6.8 rotate by 0
set yrange [0:]
...
plot for [i=1:N] fileData using (i-1):i with boxplot notitle, \
	folder.'/outliersQual.data' with labels point pt 7 notitle
